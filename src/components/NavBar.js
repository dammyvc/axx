...
const NavBar = () => {
  ...
  return (
    <header className='w-full px-32 py-8 font-medium flex items-center justify-between fixed bg-inherit z-[999] bg-white'>
        ...
        <nav className='flex items-center justify-center flex-wrap'>
            ...
            <motion.a href='https://www.linkedin.com/company/axxela' target={'_blank'}
            whileHover={{y:-2 }}
            whileTap={{scale:0.9}}
            className='w-5 mr-3'
            >
            ...
            <motion.a href='https://www.instagram.com/axxelagroup/' target={'_blank'}
        ...
        <div id='cardContainer' className='fixed top-0 right-0 h-full w-0 overflow-hidden bg-background bg-opacity-50 backdrop-blur-lg shadow-lg transition-all duration-300 z-50'>
            ...
            <div className='w-full h-full px-8 py-16 relative'>
                <div className='w-full h-auto flex flex-col gap-y-1 mt-3'>
                    <div className='w-full h-auto flex items-center gap-x-4 text-partnership hover:text-gray-100 hover:bg-partnership rounded-md px-4 py-3 ease-out duration-500 cursor-pointer'>
                    ...
                    <CustomLink href='/' title='Home' className='text-base font-medium' />
                    ...
                    <CustomLink href='/about' title='About this Report' className='text-base font-medium' />
                    ...
                    <CustomLink href='/contents' title='Contents' className='text-base font-medium' />
                    ...
                    <CustomLink href='/ceoSpeaks' title='CEO Speaks' className='text-base font-medium' />
                    ...
                    <CustomLink href='/weAreAxxela' title='We are Axxela' className='text-base font-medium' />
                    ...
                    <CustomLink href='/highPoints' title='High Points' className='text-base font-medium' />
                    ...
                    <CustomLink href='/environmentalStewardship' title='Environmental Stewardship' className='text-base font-medium' />
                    ...
                    <CustomLink href='/buildingConnections' title='Buidling Connections' className='text-base font-medium' />
                    ...
                    <CustomLink href='/communityInitiatives' title='Community Initiatives' className='text-base font-medium' />
                    ...
                    <CustomLink href='/economicContributions' title='Economic Contributions' className='text-base font-medium' />
                    ...
                    <CustomLink href='/gallery' title='Gallery' className='text-base font-medium' />
